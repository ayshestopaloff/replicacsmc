% Sample a sequence from Model 1 with replica cSMC
% and approximate predictive.

function x_new  = pg_m1_approx(y, x_cur, x_tilde_cur, M, ...
    L_post_init, L_post, L_init, L, c_vec, phi_vec, sig_vec, ...
    ...
    lw(:, 1) = lpois_vec(x_pool(:, :, 1), y(:, 1), c_vec, sig_vec) + ...
    ...
    for i = 2 : n - 1
        ...
        lw(:, i) = lpois_vec(x_pool(:, :, i), y(:, i), c_vec, sig_vec) - ...
    ...
    lw(:, n) = lpois_vec(x_pool(:, :, n), y(:, n), c_vec, sig_vec) - ...
