% Experiment 3 for the linear Gaussian model, verify we can
% achieve fixed precision with fewer particles, replica cSMC.
...
%     ylim(bd);
    ...
    for i = 1 : numiter
        ...
        for l = 1 : K
            ...
            x_seq_cur = pg_lg_approx_check(y, x_seq_cur, x_tilde_cur, ...
...
%         ylim(bd);
    ...
    savefile = strcat('lg_approx_2_check_2_',num2str(j), '.mat');    
